...
async def main():
    ...
    COURSE_TRANSLATIONS = {
        "SSH1207": "Soft Skills",
        "MIL1225": "National Defense & Security Education",
        "MI1209": "Calculus",
        "SSH1206": "General Law",
        "MI1216": "Probability & Statistics",
        "FL1219": "English 1",
        "IT1208": "Introduction to Computer Science",
        "SSH1201": "Marxist-Leninist Philosophy",
        "MI1212": "Linear Algebra",
        "SSH1202": "Marxist-Leninist Political Economy",
        "AAA": "Course AAA (Social Sciences)",
        "BBB": "Course BBB (Social Sciences)",
        "CCC": "Course CCC (STEM & Applied Science)",
        "DDD": "Course DDD (STEM & Applied Science)",
        "EEE": "Course EEE (STEM & Applied Science)",
        "FFF": "Course FFF (STEM & Applied Science)",
        "GGG": "Course GGG (STEM & Applied Science)",
    }
    ...
    for c in db_courses:
        ...
        if m and p:
            course_keys.add((m, p))
            course_meta[(m, p)] = COURSE_TRANSLATIONS.get(m, c.get("title") or c.get("name") or m)

    # Ensure all courses are registered in db.courses
    for (m, p) in course_keys:
        title = COURSE_TRANSLATIONS.get(m, course_meta.get((m, p)) or f"Course {m} ({p})")
